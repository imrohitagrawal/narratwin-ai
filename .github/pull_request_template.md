...
- [ ] Semantic closure has independent exact-head `pm-ai-shipping:intended-vs-implemented` and non-read-only `output-correctness` evidence; any `NOT_PROVEN` or `FAILED` row exits nonzero.
