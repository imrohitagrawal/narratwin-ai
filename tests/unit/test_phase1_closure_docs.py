...
def test_post_pr250_status_reconciliation_is_recorded() -> None:
    ...
    for marker in (
        ...
        "Issue `#280` is closed after PR `#293` merged the C3A-R3 PR E local/demo closure slice",
        "| `#280` | Closed | Checkpoint 3A C3A-R3 arbitrary local/demo multilingual closure | Completed through merged PR `#293`",
        "| `#296` | Closed | Frontend brace-expansion audit unblock | Completed through merged PR `#297`",
        "post-merge main quality workflow run `30146305236` passed",
        "PR `#281`",
        ...
        "Issue `#278` is closed after PR `#279` merged the bounded C3A-R2 full-project multilingual corpus gate",
        "Issue #280 is closed after PR #293 merged C3A-R3 PR E",
        "issue #249 remains open as the public Checkpoint 3 tracker",
        "C3B/3C work still requires a fresh issue, branch, PR, review, and green CI",
        ...
        "Checkpoint 3A executable acceptance probe set completed through CP1-CP8 and C3A-R3",
