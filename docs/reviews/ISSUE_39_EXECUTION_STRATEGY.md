...
| `CH-14` backup and restore drill | `DUR-RESTORE-001` | `CH-01`, `CH-02`, `CH-10`; environment readiness issues `#141`-`#149`, whose Go gate requires tested `CH-12`/`#130` alert routes | Operations/storage | Restore drill preflight covering RDS/S3 backup scope, integrity, RTO/RPO, smoke checks, restore metric emission, tested failure/timeout/cleanup/journal/KMS routes, and a re-delete handoff derived from the last-contiguous, integrity-verified current independent deletion journal rather than restored state | Operations reviewer, platform/storage reviewer, security reviewer | At least one successful restore drill has evidence, timings, database/object integrity checks, restore metrics, tested alert severity/ack/escalation/runbook links, journal/revocation-derived re-delete handoff, and residual-risk decision. CH-21 owns erasure behavior proof. |
...
| `CH-21` retention and erasure | `SEC-RETENTION-001` | `CH-02`, `CH-14`, `CH-16`, `CH-17`, `CH-18` | Security/privacy | Retention preflight covering data classes, encryption, redaction, deletion, consent revocation/takedown, backups, restores, audit exceptions, and the CH-14 re-delete handoff | Security/privacy reviewer, operations reviewer, test/evidence reviewer | PII, consent, provenance, logs, metrics, backups, restores, and replay/export blocks follow a reviewed erasure contract, including reconciliation with current CH-17 revocation state and proof that restored deleted records are re-deleted. |
