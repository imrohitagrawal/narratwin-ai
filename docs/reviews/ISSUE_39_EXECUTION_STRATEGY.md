...
| `CH-14` backup and restore drill | `DUR-RESTORE-001` | `CH-01`, `CH-02`, `CH-10` | Operations/storage | Restore drill preflight covering backup scope, integrity, RTO/RPO, smoke checks, re-delete behavior, and restore metric emission | Operations reviewer, platform/storage reviewer, security reviewer | At least one successful restore drill has evidence, timings, integrity checks, restore metrics, and residual-risk decision. |
...
| `CH-21` retention and erasure | `SEC-RETENTION-001` | `CH-02`, `CH-14`, `CH-16`, `CH-18` | Security/privacy | Retention preflight covering data classes, encryption, redaction, deletion, backups, restores, audit exceptions | Security/privacy reviewer, operations reviewer, test/evidence reviewer | PII, consent, provenance, logs, metrics, backups, restores, and replay/export blocks follow a reviewed erasure contract. |
