...
| Exact route/budget was prose-only | Temp forbidden path and generic GPF adapter both returned no finding. | REQUIRED_CONTRACT | checker writer | Second blocker class stopped work; RED then live base/branch/path/budget oracle corrected it. |
