...
Keep `PHF-007` through `PHF-014` available for follow-up triage. `PHF-001`
through `PHF-006` are closed in the current working tree and should stay covered
by guardrail and Phase 1 closure-gate tests before merge.
