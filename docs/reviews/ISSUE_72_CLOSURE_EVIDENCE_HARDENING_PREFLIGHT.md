...
| CEH-002 | Context 0 proof | `PR #64` or Context 0 artifact-only references are reused as final row proof. | Reject PR `#64`, PR number/pull request text variants, and Context 0 artifact-only references for sensitive rows. | `test_phase1_issue39_pull_request_rejects_context0_pr64_as_final_row_proof`, `test_phase1_issue39_pull_request_rejects_context0_pr64_text_variants` | pass |
