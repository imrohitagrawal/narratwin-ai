...
| pypdf | Future PDF text extraction for project knowledge ingestion | BSD-3-Clause per upstream license and PyPI metadata; full public-distribution review remains pending | Permitted for controlled-local dependency preparation; public use remains unapproved | Stage 4 dependency prep; Issue `#401` security prerequisite | Direct lower bound and sole lock record move from affected 6.14.2 to official 6.15.0 for CVE-2026-71852 and CVE-2026-71870. PyPI provenance binds the wheel SHA-256 `14e001d6504822cb1ca9c7ed9a69bccb320f59b320730f55af804361abe4d5ee` and sdist SHA-256 `d39c4d955a76409284a905e2d65b40076d77ab76129e0faaeeb6612403ecfc79` to `py-pdf/pypdf`. Product code does not import pypdf; PDF uploads remain rejected and are not represented as supported. |
...
implementation uses only Python standard-library validation plus injected fake
protocols. It installs no Google SDK, contains no Google binary/model/voice asset,
