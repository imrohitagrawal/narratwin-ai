...
| P1-R7 | Semgrep upstream still pins an advisory-bearing MCP release | P1 | `#138`, `#150`, `#158` | Issue `#150` upgrades the isolated tool to Semgrep `1.172.0`, removes the obsolete Click override, and retains only fixed MCP `1.28.1`. The renewed exception expires `2026-08-28`; strict audits, reviewed-input hashes, scan/canaries, and nonproduction posture remain mandatory. |
