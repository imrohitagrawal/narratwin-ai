...
| `docs/ADR/0010-context3-migrations-rollback-compatibility.md` | Migration expand/contract strategy, forward-only rollback posture, schema compatibility windows, and artifact-state compatibility planning for issue `#39` Context 3 | Phase 1 Closure / `#67`, PR pending | Added |
