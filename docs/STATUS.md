...
| `#428` | Active | Security prerequisite | Current audit expansion makes transitive Nano ID `3.3.17` High severity. The bounded route refreshes only official `3.3.18`; Issue #150 and frozen #427 remain serialized until merged-main acceptance. No product/release/production posture changes. |
