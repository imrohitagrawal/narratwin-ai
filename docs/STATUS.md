...
| `#460` | Active | Security prerequisite | Exact branch `security-460-semgrep-override-removal` pins isolated Semgrep `1.175.0`, accepts upstream Click `8.4.2`, MCP `1.29.0`, and PyJWT `2.13.0`, and removes every tool override. Checkpoint `5456985567` expands only the demonstrated Issue `#16`, `#427`, and `#434` immutable-history convergence boundary to a 21-path, 2,000-line route. TDD, generated-lock review, strict audits, scan/canaries, hosted parity, independent review, and merged-main verification remain required; release/production stays No-Go. |
