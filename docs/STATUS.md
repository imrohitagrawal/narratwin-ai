...
- Current repo mode: Final Review has merged; Phase 1 Closure is active,
  ...
  and PR `#218`, post-PR-218 status reconciliation has merged through issue `#221` and PR `#222`, issue `#223` is the active post-PR-222 status reconciliation,
...
| SSV1-NEXT | next-action | #223 | post-pr-222-status-reconciliation-active | post-pr-222-status-reconciliation-active | Issue #223 is the active post-PR-222 repository-ledger reconciliation after PR #222 merged issue #221 status reconciliation. |
...
- Issue `#223` is the active post-PR-222 repository-ledger reconciliation.
...
3. Complete issue `#223` as the narrow post-PR-222 repository-ledger
   reconciliation for issue `#221`, PR `#222`, and the next serialized
