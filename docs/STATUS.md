...
- Current repo mode: Final Review has merged; Phase 1 Closure is active,
  ...
  through issue `#192` and PR `#193`, mutable current-state authority is
...
- Out-of-band GitHub reconciliation: PR `#45` merged the Final Review artifacts at
  ...
  `7131924937e5433d7de2517e14dd1a328d97a063`; live GitHub also shows issue
...
- Issue `#192` is closed through merged PR `#193`; the post-PR-191 status
  reconciliation is no longer the current action.
