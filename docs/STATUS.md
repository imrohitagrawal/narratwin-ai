...
- Out-of-band GitHub reconciliation: PR `#45` merged the Final Review artifacts at
  ...
  execution; issues `#95`, `#96`, and `#97` are open for `CH-05`, `CH-06`,
  and `CH-04` respectively; and issues `#43`, `#44`, `#48`, and `#49` remain
  open.
...
| Phase 1 Closure | In progress | `#35`, `#36`, `#37`, `#40`, `#41`, `#42`, `#55`, `#58`, `#60`, `#65`, `#66`, `#67`, `#68`, `#69`, `#70`, `#71`, `#72`, `#84`, `#86`, `#89`, and `#93` closed; `#38` resolved with live settings evidence and required-context drift checking through merged PR `#53`; `#39`, `#43`, `#44`, `#48`, `#49`, `#95`, `#96`, and `#97` open | PRs `#46`, `#47`, `#50`, `#53`, `#54`, `#56`, `#59`, `#62`, `#63`, `#64`, `#73`, `#74`, `#75`, `#76`, `#77`, `#78`, `#79`, `#80`, `#85`, `#87`, `#90`, `#92`, and `#94` merged | Executable governance gate added | `#39` remains open as the remaining P1 production blocker despite context planning progress across `#65`-`#70`. Issues `#65`-`#70` are now closed through PRs `#75`-`#80` respectively. `#71` and `#72` are closed process-hardening follow-ups through PRs `#73` and `#74`. Issue `#86` completed `CH-01` migration-baseline execution for `DUR-MIG-001` through merged PR `#87`. Issue `#93` completed `CH-02` ACID/CAS storage-kernel execution for `DUR-ACID-001` through merged PR `#94`. Issues `#97`, `#95`, and `#96` now carry `CH-04`, `CH-05`, and `CH-06` respectively as the next parallel post-`CH-02` implementation chunks. Issue `#89` completed the merge-closeout ownership codification through merged PR `#90`. `#43`, `#44`, `#48`, and `#49` remain P2/follow-up unless they block Phase 1 correctness; `#60` is complete as a process-only PHF follow-up with no product/runtime scope. |
...
| `#95` | Open | Phase 1 follow-on | `CH-05` lease fencing execution for `DUR-LEASE-001`; scope is limited to acquire/heartbeat/expiry/reclaim semantics, monotonic fencing tokens, stale-writer rejection, branch-scope guardrails, and supporting ADR/status/traceability updates while issue `#39` remains open. |
| `#96` | Open | Phase 1 follow-on | `CH-06` committed outbox execution for `DUR-OUTBOX-001`; scope is limited to same-transaction state/event writes, dispatcher acquire/retry/success/fail transitions, at-least-once dispatch semantics, idempotent consumer policy, focused `CTX2-OUTBOX-EVID-001` kernel tests, and supporting ADR/status/traceability updates while issue `#39` remains open. |
| `#97` | Open | Phase 1 follow-on | `CH-04` idempotency semantics execution for `DUR-IDEMP-001`; scope is limited to canonical operation identity, payload-hash conflict guarding, terminal replay behavior, stale-owner rejection, branch-scope guardrails, and supporting ADR/status/traceability updates while issue `#39` remains open. |
...
| 2026-07-11 | Issue `#96` started on branch `phase-1-closure-39-ch-06-committed-outbox`; `CH-06` stays limited to the `DUR-OUTBOX-001` storage kernel contract with same-transaction state/event writes, dispatcher transition primitives, at-least-once redelivery, and focused `CTX2-OUTBOX-EVID-001` tests while issue `#39` remains open. |
