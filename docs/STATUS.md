...
| SSV1-NEXT | next-action | repo owner | decision-required | decision-required | After Issue #319 closeout, the next action requires explicit authority. Issue #317 remains open after post-merge acceptance found two compatibility regressions; its correction remains a reserved owner decision. Mandatory reading, Issue #280, PR #299, product/runtime, providers, deployment, release, and production posture remain unchanged. |
