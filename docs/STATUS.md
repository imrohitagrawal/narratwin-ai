...
| `#77` | In progress | 2026-07-10 | Context 3 migration/rollback compatibility planning PR for issue `#67` / issue `#39`; advisory-only ADR + planned evidence mapping, branch-scope checks update only. |
