...
| `#67` | In progress | Phase 1 follow-on | Context 3 migration/rollback compatibility planning for issue `#39`; advisory-only `DUR-MIG-001` and `DUR-ROLLBACK-001` planning. Runtime migration execution remains deferred. |
...
| PR pending for issue `#67` | In progress | 2026-07-10 | Context 3 migration/rollback compatibility planning for issue `#39`; advisory-only ADR + planned evidence mapping, branch-scope checks update only. |
