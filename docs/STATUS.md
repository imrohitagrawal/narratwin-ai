...
[Issue #519 / PR #546](https://github.com/imrohitagrawal/narratwin-ai/pull/546) prepares the [experiment-first execution package](work/demo-comparison/EXECUTION_PLAN.md), with [decisions](work/demo-comparison/DECISIONS.md), [review/failure evidence](work/demo-comparison/evidence/REVIEWS.md) and [handoff](work/demo-comparison/HANDOFF.md). It preserves the archived proposal and exact canonical inputs; no exploratory A1–A6 amendment, provider qualification or operation is accepted by this package. PR545 is retired unmerged with its failed attempt preserved. Public research, zero-exposure preparation and eligible UI planning are independent of blanket G1/G2/G3 ordering; #531 accepted-current implementation dependencies and #532's actual provider/account/security-incident stops remain binding.

T05 audio acceptance remains complete; T06 has zero accepted real presenter cells and T07/T08 remain incomplete. This enabling documentation and exact-scope verification change adds no user-facing capability. Representative complete-output quality, actual browser-to-backend media/caption/playback/export and exact-artifact human acceptance remain unproved. [#543 / draft PR544](https://github.com/imrohitagrawal/narratwin-ai/pull/544) owns further source corrections and its failed verification evidence; this package neither changes those bytes nor completes G1 certification/adoption. Required hosted checks, independent exact-head review and enforced approval remain separate merge gates. Routine tracker/check/cleanup observations stay in issue/PR comments.
