...
- Current repo mode: Final Review has merged; Phase 1 Closure is active,
  ...
  and PR `#218`, issue `#221` is the active post-PR-218 status reconciliation,
...
| SSV1-NEXT | next-action | #221 | post-pr-218-status-reconciliation-active | post-pr-218-status-reconciliation-active | Issue #221 is the active post-PR-218 repository-ledger reconciliation after PR #218 merged issue #217 status reconciliation. |
...
- Issue `#221` is the active post-PR-218 repository-ledger reconciliation.
...
3. Complete issue `#221` as the narrow post-PR-218 repository-ledger
   reconciliation for issue `#217`, PR `#218`, and the next serialized
