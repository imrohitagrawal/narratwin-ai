...
| `#151` | Open, remediation implemented for review | Security follow-up | Backend runtime now derives from the pinned Python `3.13.14` image with the three authorized CPython backports applied and scanner consensus requiring both Trivy and Grype plus fixed-status evidence for only `CVE-2026-11940`, `CVE-2026-11972`, and `CVE-2026-15308`; merge remains subject to PR review, CI, and closeout. |
