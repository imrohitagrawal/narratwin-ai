...
- Date: 2026-07-29
- Authority: Issue #308 and canonical comment `5118185764`
...
Use two serialized PRs. PR A establishes exact branch/allowlist policy and an independent, fail-closed evidence verifier. PR B may then connect the existing curation UI to the existing Stage 4, 6, and 7 contracts using one `curator_demo` project and the Next rewrite.
