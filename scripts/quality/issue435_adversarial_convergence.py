...
STATIC_GIT_METADATA_READER_AST_SHA256 = (
    "0651a00c589cbe795c3e69a41b454f1b57dd04a5619d6a5a6c507b445cd7c374"
)
STATIC_GIT_METADATA_DISCOVERY_AST_SHA256 = (
    "4d4bf1c36eeef55532932833965dccb37b613edaf151c71a6c244735ab108aed"
)
...
STATIC_GIT_METADATA_CASES = (
    ("conventional-positive", "conventional", "dot_git", "directory", None, ".git"),
    ("dot-git-missing", "conventional", "dot_git", "missing", "ACP.GIT_METADATA.MISSING", ".git"),
    (
    ...
    ("dot-git-fifo", "conventional", "dot_git", "fifo", "ACP.GIT_METADATA.WRONG_TYPE", ".git"),
    (
    ...
    ("dot-git-crlf", "linked", "dot_git", "crlf", "ACP.GIT_METADATA.RECORD_SHAPE", ".git"),
    (
    ...
    (
        ...
        "both",
        "dot_git",
        "device-or-inode-drift",
        "ACP.GIT_METADATA.IDENTITY_CHANGED",
        ".git",
    ),
    ("fstat-type", "both", "dot_git", "type-drift", "ACP.GIT_METADATA.WRONG_TYPE", ".git"),
    (
        "post-read-identity",
        "linked",
        "dot_git",
    ...
    ("short-read", "linked", "dot_git", "one-byte-chunks-to-eof", None, ".git"),
    ("read-type", "linked", "dot_git", "non-bytes", "ACP.GIT_METADATA.READ_TYPE", ".git"),
    (
        "io-error",
        "both",
        "dot_git",
        "lstat-open-read-or-close-error",
        "ACP.GIT_METADATA.IO_ERROR",
        ".git",
    ),
    ("reverse-close", "both", "dot_git", "all-held-descriptors-once-reverse-order", None, ".git"),
    ("grafts-present", "both", "grafts", "any-inode", "ACP.GIT_METADATA.PROHIBITED", "info/grafts"),
    (
    ...
    ("shallow-present", "both", "shallow", "any-inode", "ACP.GIT_METADATA.PROHIBITED", "shallow"),
    (
