...
def check_exact_route(
    ...
    try:
        ...
        if branch in {ISSUE482_BRANCH, ISSUE478_BRANCH, ISSUE475_BRANCH, ISSUE459_BRANCH, ISSUE459_T03_BRANCH, ISSUE459_T05A_BRANCH,
                      ISSUE459_T05B_BRANCH, ISSUE466_BRANCH}:
            transition_base = ISSUE459_TRANSITION_BASE if branch == ISSUE459_BRANCH else base
            transitions = (
                *(() if branch in {ISSUE482_BRANCH, ISSUE478_BRANCH, ISSUE475_BRANCH, ISSUE459_T03_BRANCH, ISSUE459_T05A_BRANCH,
