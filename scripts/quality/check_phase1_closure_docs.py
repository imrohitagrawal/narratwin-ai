...
ISSUE_257_ALLOWED_CHANGED_FILES = {
...
ISSUE_259_ALLOWED_CHANGED_FILES = {
...
ISSUE_263_ALLOWED_CHANGED_FILES = {
...
ISSUE_265_ALLOWED_CHANGED_FILES = {
...
ISSUE_267_ALLOWED_CHANGED_FILES = {
...
ISSUE_280_PR_B_ALLOWED_CHANGED_FILES = {
...
ISSUE_280_PR_C_ALLOWED_CHANGED_FILES = {
...
ISSUE_289_ALLOWED_CHANGED_FILES = {
...
STATUS_STATE_V1_ROWS = {
    ...
    "SSV1-NEXT": (
        "next-action",
        "issue #291 / post-pr-284-status-reconciliation",
        "post-pr-284-reconciliation-active",
        "post-pr-284-reconciliation-active",
...
def check_changed_files(failures: list[str]) -> None:
    ...
    if branch.startswith("phase-1-closure-141-"):
    ...
    elif branch == "phase-1-closure-process-257-c3a-cp2-output-correctness":
    ...
    elif branch == "phase-1-closure-263-c3a-cp5-access-quota-retention":
        allowed_files = ISSUE_263_ALLOWED_CHANGED_FILES
    elif branch == "phase-1-closure-265-c3a-cp6-security-observability":
    ...
    elif branch == ISSUE_280_PR_B_BRANCH:
        allowed_files = ISSUE_280_PR_B_ALLOWED_CHANGED_FILES
    elif branch == ISSUE_280_PR_C_BRANCH:
        ...
        allowed_files = set()
    elif branch.startswith("phase-1-closure-265-"):
        allowed_files = set()
    elif branch.startswith("phase-1-closure-263-"):
        allowed_files = set()
...
def check_issue257_c3a_cp2_preflight(failures: list[str]) -> None:
    rel = "docs/reviews/ISSUE_257_C3A_CP2_PREFLIGHT.md"
    if not (ROOT / rel).is_file():
        fail(failures, f"Missing required C3A-CP2 preflight artifact: {rel}")
        return
    text = read(rel)
    normalized = re.sub(r"\s+", " ", text.lower())
    check_required_headings(
    ...
    missing_urls = [url for url in required_urls if url not in text]
    if missing_urls:
        fail(failures, f"{rel} missing C3A-CP2 official source URLs: " + ", ".join(missing_urls))
    ...
    required_markers = (
        ...
        "C3A-CP2-HARNESS-001",
        "C3A-CP2-OUTPUT-001",
        "C3A-CP2-EVIDENCE-001",
        "C3A-CP2-NONGOAL-001",
        "C3A-CP2-FALSEPASS-001",
        "C3A-CP2-BINDING-001",
        "C3A-CP2-UNSUPPORTED-001",
        "C3A-CP2-ISOLATION-001",
        "C3A-CP2-REDACTION-001",
        "C3A-CP2-TIMEOUT-001",
        "C3A-CP2-FM-001",
        "C3A-CP2-FM-002",
        "C3A-CP2-FM-003",
        ...
        "tests/acceptance/test_checkpoint3_output_correctness.py::test_checkpoint3_output_correctness_rejects_correct_text_without_evidence_binding",
        "tests/acceptance/test_checkpoint3_output_correctness.py::test_checkpoint3_output_correctness_rejects_unsupported_claim_acceptance",
        "tests/acceptance/test_checkpoint3_output_correctness.py::test_checkpoint3_output_correctness_rejects_cross_project_fact_replay",
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_rejects_static_output_correctness_probe_command",
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_redacts_runtime_evidence_fields",
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_timeout_is_bounded_and_redacted",
        "sub-agent",
    ...
    missing_markers = [marker for marker in required_markers if marker.lower() not in normalized]
    if missing_markers:
        fail(failures, f"{rel} missing C3A-CP2 preflight markers: " + ", ".join(missing_markers))


def check_issue259_c3a_cp3_preflight(failures: list[str]) -> None:
    rel = "docs/reviews/ISSUE_259_C3A_CP3_PREFLIGHT.md"
    if not (ROOT / rel).is_file():
        fail(failures, f"Missing required C3A-CP3 preflight artifact: {rel}")
        return
    text = read(rel)
    normalized = re.sub(r"\s+", " ", text.lower())
    check_required_headings(
    ...
    missing_urls = [url for url in required_urls if url not in text]
    if missing_urls:
        fail(failures, f"{rel} missing C3A-CP3 official source URLs: " + ", ".join(missing_urls))
    ...
    required_markers = (
        ...
        "timeout=120",
        "C3A-CP3-HARNESS-001",
        "C3A-CP3-LANGUAGE-001",
        "C3A-CP3-RUNTIME-001",
        "C3A-CP3-NONGOAL-001",
        "C3A-CP3-FALSEPASS-001",
        "C3A-CP3-PLACEHOLDER-001",
        "C3A-CP3-SHORT-001",
        "C3A-CP3-DEBUG-001",
        "C3A-CP3-CITATION-001",
        "C3A-CP3-ISOLATION-001",
        "C3A-CP3-REDACTION-001",
        "C3A-CP3-TIMEOUT-001",
        "C3A-CP3-FM-001",
        "C3A-CP3-FM-002",
        "C3A-CP3-FM-003",
        ...
        "tests/acceptance/test_checkpoint3_language_quality.py::test_checkpoint3_language_quality_rejects_grounded_placeholder_boilerplate_output",
        "tests/acceptance/test_checkpoint3_language_quality.py::test_checkpoint3_language_quality_rejects_trivially_short_citation_output",
        "tests/acceptance/test_checkpoint3_language_quality.py::test_checkpoint3_language_quality_rejects_debug_or_internal_leakage",
        "tests/acceptance/test_checkpoint3_language_quality.py::test_checkpoint3_language_quality_rejects_malformed_citation_placement",
        "tests/acceptance/test_checkpoint3_language_quality.py::test_checkpoint3_language_quality_rejects_cross_project_or_unsupported_language_insertions",
        ...
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_rejects_static_language_quality_probe_command",
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_redacts_runtime_evidence_fields",
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_timeout_is_bounded_and_redacted",
        "sub-agent",
        "Cross-model review is skipped in this autonomous execution context",
...
def check_issue263_c3a_cp5_preflight(failures: list[str]) -> None:
    rel = "docs/reviews/ISSUE_263_C3A_CP5_PREFLIGHT.md"
    if not (ROOT / rel).is_file():
        fail(failures, f"Missing required C3A-CP5 preflight artifact: {rel}")
        return
    text = read(rel)
    normalized = re.sub(r"\s+", " ", text.lower())
    check_required_headings(
    ...
    missing_urls = [url for url in required_urls if url not in text]
    if missing_urls:
        fail(failures, f"{rel} missing C3A-CP5 official source URLs: " + ", ".join(missing_urls))
    ...
    required_markers = (
        ...
        "C3A-CP5-RUNTIME-001",
        "C3A-CP5-NONGOAL-001",
        "C3A-CP5-FALSEPASS-001",
        "C3A-CP5-ACCESS-001",
        "C3A-CP5-IDEMPOTENCY-001",
        "C3A-CP5-QUOTA-001",
        "C3A-CP5-RETENTION-001",
        "C3A-CP5-REDACTION-001",
        "C3A-CP5-FM-001",
        "C3A-CP5-FM-002",
        "C3A-CP5-FM-003",
        "C3A-CP5-FM-004",
        ...
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_rejects_static_access_quota_retention_probe_command",
    ...
    missing_markers = [marker for marker in required_markers if marker.lower() not in normalized]
    if missing_markers:
        fail(failures, f"{rel} missing C3A-CP5 preflight markers: " + ", ".join(missing_markers))


def check_issue265_c3a_cp6_preflight(failures: list[str]) -> None:
    rel = "docs/reviews/ISSUE_265_C3A_CP6_PREFLIGHT.md"
    if not (ROOT / rel).is_file():
        fail(failures, f"Missing required C3A-CP6 preflight artifact: {rel}")
        return
    text = read(rel)
    normalized = re.sub(r"\s+", " ", text.lower())
    check_required_headings(
    ...
    missing_urls = [url for url in required_urls if url not in text]
    if missing_urls:
        fail(failures, f"{rel} missing C3A-CP6 official source URLs: " + ", ".join(missing_urls))

    required_markers = (
        "C3A-CP6-HARNESS-001",
        "C3A-CP6-SECURITY-001",
        "C3A-CP6-OBSERVABILITY-001",
        "C3A-CP6-REDACTION-001",
        "C3A-CP6-FALSEPASS-001",
        "C3A-CP6-NONGOAL-001",
        "C3A-CP6-FM-001",
        "C3A-CP6-FM-002",
        "C3A-CP6-FM-003",
        ...
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_rejects_static_security_observability_probe_command",
    ...
    missing_markers = [marker for marker in required_markers if marker.lower() not in normalized]
    if missing_markers:
        fail(failures, f"{rel} missing C3A-CP6 preflight markers: " + ", ".join(missing_markers))


def check_issue267_c3a_cp7_preflight(failures: list[str]) -> None:
    rel = "docs/reviews/ISSUE_267_C3A_CP7_PREFLIGHT.md"
    if not (ROOT / rel).is_file():
        fail(failures, f"Missing required C3A-CP7 preflight artifact: {rel}")
        return
    text = read(rel)
    normalized = re.sub(r"\s+", " ", text.lower())
    check_required_headings(
    ...
    missing_urls = [url for url in required_urls if url not in text]
    if missing_urls:
        fail(failures, f"{rel} missing C3A-CP7 official source URLs: " + ", ".join(missing_urls))

    required_markers = (
        "C3A-CP7-HARNESS-001",
        "C3A-CP7-PERFORMANCE-001",
        "C3A-CP7-BINDING-001",
        "C3A-CP7-REDACTION-001",
        "C3A-CP7-FALSEPASS-001",
        "C3A-CP7-NONGOAL-001",
        "C3A-CP7-FM-001",
        "C3A-CP7-FM-002",
        "C3A-CP7-FM-003",
        ...
        "tests/unit/test_checkpoint3_acceptance_gate.py::test_checkpoint3_acceptance_rejects_static_performance_probe_command",
    ...
    missing_markers = [marker for marker in required_markers if marker.lower() not in normalized]
    if missing_markers:
        fail(failures, f"{rel} missing C3A-CP7 preflight markers: " + ", ".join(missing_markers))


def check_issue269_c3a_cp8_preflight(failures: list[str]) -> None:
    rel = "docs/reviews/ISSUE_269_C3A_CP8_PREFLIGHT.md"
    if not (ROOT / rel).is_file():
        fail(failures, f"Missing required C3A-CP8 preflight artifact: {rel}")
        return
    text = read(rel)
    normalized = re.sub(r"\s+", " ", text.lower())
    check_required_headings(
    ...
    missing_urls = [url for url in required_urls if url not in text]
    if missing_urls:
        fail(failures, f"{rel} missing C3A-CP8 official source URLs: " + ", ".join(missing_urls))
    ...
    required_markers = (
        ...
        "C3A-CP8-BINDING-001",
        "C3A-CP8-REDACTION-001",
        "C3A-CP8-FALSEPASS-001",
        "C3A-CP8-NONGOAL-001",
        "C3A-CP8-FM-001",
        "C3A-CP8-FM-002",
        "C3A-CP8-FM-003",
...
def check_process_docs(failures: list[str]) -> None:
    ...
    check_issue263_c3a_cp5_preflight(failures)
