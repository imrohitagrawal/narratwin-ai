...
{"status":"tool_unavailable","required":"trivy, grype, or docker scout","budget":"no critical/high container vulnerabilities"}
JSON
  echo "Docker image vulnerability scanning requires trivy, grype, or docker scout."
  exit 1
fi
